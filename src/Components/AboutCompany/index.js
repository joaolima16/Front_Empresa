    ...
    <>
      <section className="About" id="sobre">
        <main className="HistoryCompany">
          ...
          <br />
          <p className="History">
            Toda essa dedicação e investimento transformaram a
            <strong> KMG CONSTRUTORA </strong>em uma empresa com referência de
            qualidade e competência na área de construção civil, principalmente
            no segmento do Saneamento Básico.
          </p>
        </main>
      </section>
